...
public abstract class AbstractOperationsCorrelationPersistenceTest
    extends AbstractCorrelationPersistenceTest {

  @Override
  protected AllStrategyCorrelationInfoFactory getAllStrategyCorrelationInfoFactory() {
    return PersistenceAllStrategyCorrelationInfoFactories.from(
        persistenceExecutor(), persistenceOperations());
  }

  protected abstract PersistenceInstanceOperations persistenceOperations();
}
