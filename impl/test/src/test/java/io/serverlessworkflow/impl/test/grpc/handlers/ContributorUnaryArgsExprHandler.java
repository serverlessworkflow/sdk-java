...
import static io.serverlessworkflow.impl.executors.grpc.contributors.UnaryArgsExprGrpc.UnaryArgsExprImplBase;

import io.grpc.stub.StreamObserver;
import io.serverlessworkflow.impl.executors.grpc.contributors.Contributors;

public class ContributorUnaryArgsExprHandler extends UnaryArgsExprImplBase {
  ...
  public void createContributor(
    ...
    responseObserver.onNext(
        Contributors.AddContributionResponse.newBuilder()
            .setMessage("Success with " + request.getGithub())
            .build());
