...
import person.PersonGrpc.PersonImplBase;
import person.PersonOuterClass;

public class PersonUnaryHandler extends PersonImplBase {
  ...
  public void getPerson(
    ...
    responseObserver.onNext(
        PersonOuterClass.GetPersonResponse.newBuilder().setId(891182).setName("John Doe").build());
