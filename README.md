...
```text
implementation("io.serverlessworkflow:serverlessworkflow-api:2.0.0.Final")
implementation("io.serverlessworkflow:serverlessworkflow-spi:2.0.0.Final")
implementation("io.serverlessworkflow:serverlessworkflow-validation:2.0.0.Final")
implementation("io.serverlessworkflow:serverlessworkflow-diagram:2.0.0.Final")
```
