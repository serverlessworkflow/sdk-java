...
```text
implementation("io.serverlessworkflow:serverlessworkflow-api:4.0.2.Final")
implementation("io.serverlessworkflow:serverlessworkflow-spi:4.0.2.Final")
implementation("io.serverlessworkflow:serverlessworkflow-validation:4.0.2.Final")
implementation("io.serverlessworkflow:serverlessworkflow-diagram:4.0.2.Final")
implementation("io.serverlessworkflow:serverlessworkflow-util:4.0.2.Final")
```
